...
<main class="h-screen w-screen overflow-hidden flex flex-col items-center justify-center bg-gray-800">
  <div class="flex justify-center"></div>
    <div class="grid grid-cols-6 gap-4 w-3/4 place-items-center">
